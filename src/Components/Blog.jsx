...
function Blog() {
  ...
  return (
    <div className=' px-4 sm:px-6 md:px-12 xl:px-16 2xl:px-80 mt-16 md:mt-44' id='blog'>
        ...
        <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-6  mt-10'>
            {
                blogs.map((blog,index)=>(
                    <div key={index} className=' overflow-hidden shadow-md hover:shadow-lg transition-shadow ease-in-out duration-300 rounded-md'>
                        ...
                        <p className='text-lg font-semibold mt-4 text-gray-500 px-4 pb-8'>{blog.description}</p>
                    </div>
                ))
            }
        </div>
